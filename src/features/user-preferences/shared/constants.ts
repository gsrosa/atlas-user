/** User preferences — field keys and options must match nexploring-bff `traveler-profile` Zod enums. */
...
export const INTEREST_OPTIONS: ProfileOption[] = [
...
export const PROFILE_QUESTIONS: ProfileQuestion[] = [
  ...
  },
  {
    ...
    type: "single",
    options: [
      { value: "researcher",    label: "I research everything",      emoji: "🔍", description: "Detailed plans and bookings upfront" },
      { value: "loose-planner", label: "Loose plans, discover the rest", emoji: "🗺️", description: "Skeleton itinerary, room for spontaneity" },
      { value: "wanderer",      label: "I arrive and wander",        emoji: "🌀", description: "Minimal planning — follow the moment" },
    ],
  },
  {
    field: "interests",
  ...
  },
  {
    ...
    type: "single",
    options: [
      { value: "sedentary", label: "Easy-going", emoji: "🧘", description: "Relaxed days, minimal hiking" },
      { value: "active",    label: "Active",     emoji: "🚶", description: "Walking, light hikes, cycling" },
      { value: "athletic",  label: "Athletic",   emoji: "🏃", description: "Challenging trails and long days" },
    ],
  },
  {
  ...
  },
  {
    ...
    type: "single",
    options: [
      { value: "transcendent-experience", label: "A once-in-a-lifetime moment", emoji: "✨", description: "One peak experience you still talk about" },
      { value: "consistent-quality",      label: "Consistent comfort",          emoji: "🏆", description: "Everything worked — no weak days" },
      { value: "unexpected-discoveries",  label: "Unexpected finds",            emoji: "🎲", description: "Places that were not in any guide" },
      { value: "food-drink",              label: "Food & drink",                emoji: "🍷", description: "Meals that defined the trip" },
      { value: "human-connections",       label: "Human connections",           emoji: "🤝", description: "Conversations and locals you remember" },
      { value: "being-lost-in-place",     label: "Feeling lost in the best way", emoji: "🧭", description: "Immersion — the rhythm of a place" },
    ],
  },
]
